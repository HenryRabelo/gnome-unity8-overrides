...
# GSchema Overrides #
sudo cp ./backgrounds/Saucy-Salamander.jpg /usr/share/backgrounds/gnome/
...
cat ./overrides/dash-background-mod.css >> /usr/share/themes/Yaru-dark/gnome-shell/gnome-shell.css
